...
function PDFViewer({
  ...
  const { zoomIn, zoomOut, goToNextPage, goToPreviousPage } =
    useKeyboardShortcuts(setZoomLevel, setPageNumber, numPages);
  ...
  return (
    <div
      className={cn('tw-flex tw-flex-col tw-h-full tw-w-full tw-relative')}
      ref={pdfRef}
    >
      {as === 'pdf-viewer' && (
        <Nav
